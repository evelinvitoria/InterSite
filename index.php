...
<body>
    ...
    <main>
        ...
        <section class="imagens">
            <img src="img/sobrancelha1.png" alt="Sobrancelhas" class="sobrancelha-1">
            <img src="img/sobrancelha2.png" alt="Penteados" class="penteado-1">
        </section>
        ...
        <div class="botoes">
            ...
            <button class="botao" onclick="location.href='spalabios.php'">Spa de Lábios</button>
        </div>
    </main>
